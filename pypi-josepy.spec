...
Source0  : https://files.pythonhosted.org/packages/e1/e1/e531cc19a0b74b1d09877a67b5935e0be22e2cbbf15cecb36ec97378b644/josepy-1.12.0.tar.gz
...
%prep
%setup -q -n josepy-1.12.0
cd %{_builddir}/josepy-1.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1642005703
...
cp %{_builddir}/josepy-1.12.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-josepy/d095fa0d394cc9417a65aecd0d28e7d10e762f98
