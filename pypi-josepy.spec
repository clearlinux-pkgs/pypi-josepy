...
Source0  : https://files.pythonhosted.org/packages/9d/19/4ebe24c42c341c5868dff072b78d503fc1b0725d88ea619d2db68f5624a9/josepy-2.1.0.tar.gz
...
%prep
%setup -q -n josepy-2.1.0
cd %{_builddir}/josepy-2.1.0
pushd ..
cp -a josepy-2.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1752016296
