...
Source0  : https://files.pythonhosted.org/packages/c1/8a/cd416f56cd4492878e8d62701b4ad32407c5ce541f247abf31d6e5f3b79b/josepy-1.15.0.tar.gz
...
%prep
%setup -q -n josepy-1.15.0
cd %{_builddir}/josepy-1.15.0
pushd ..
cp -a josepy-1.15.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737639341
